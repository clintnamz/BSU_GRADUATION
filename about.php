...
<div class="container">
    <section id="showcase">
        <div class="container">
            <p> This system has been  developed using PHP and
                 MySQL, Ajax, JQuery & Bootstrap
                to manage the graduation clearance process
                 of all Final Year Students at Bishop Stuart university to
                  replace their manual process that they have been using. 
            </p>
        </div>
    </section>
</div>
...
<div class="container">
    <footer id="main-footer">
        <p> Copyright &copy; 2018 clintnamz Clearance</p>
    </footer>
</div>
<style>
    body{
